        ...
        <div className="flex items-center gap-6">
           <div className="flex gap-4 text-sm text-gray-600 hidden lg:flex bg-gray-50 px-4 py-2 rounded-lg border border-gray-100">
            ...
            <div className="flex items-center gap-1">
               ...
               <span className="font-mono">{device.operational.ambient_air}°C</span>
            </div>
          </div>
          ...
          <Tabs.Root value={activeView} onValueChange={setActiveView}>
            <Tabs.List className="flex bg-gray-100 p-1 rounded-lg">
              ...
              >
                ...
                <span className="hidden sm:inline">Monitoreo y Análisis</span>
              </Tabs.Trigger>
            </Tabs.List>
          </Tabs.Root>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               <div className="bg-white p-6 rounded-lg border shadow-sm">
                  <h3 className="font-semibold mb-4 text-gray-800">Estado del Proceso Actual</h3>
                  {device.process ? (
                    ...
                    <div className="text-center py-8 text-gray-400">
                      ...
                      <p>No hay proceso activo</p>
                    </div>
                  )}
               </div>

               <div className="bg-white p-6 rounded-lg border shadow-sm">
                  <h3 className="font-semibold mb-4 text-gray-800">Datos Operacionales</h3>
                  <div className="space-y-3 text-sm">
                     <div className="flex justify-between border-b border-gray-50 pb-2">
                       <span className="text-gray-500">Consumo Energía</span>
                     ...
                     <div className="flex justify-between border-b border-gray-50 pb-2">
                       <span className="text-gray-500">Intervalo Defrost</span>
                       <span className="font-mono">{device.operational.defrost_interval}h</span>
                     </div>
                     <div className="flex justify-between pb-2">
                       <span className="text-gray-500">Bobina Evaporación</span>
                       <span className="font-mono">{device.operational.evaporation_coil}°C</span>
                     </div>
                  </div>
               </div>
            </div>
