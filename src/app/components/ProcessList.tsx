  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Seguimiento de Procesos</h1>
          <p className="text-gray-500 text-sm">Gestione lotes activos, historial y nuevos servicios.</p>
        </div>
      ...
      <div className="flex gap-4 mb-6">
        <div className="relative flex-1 max-w-md">
          ...
          <input 
            type="text" 
            placeholder="Buscar por cliente, lote o producto..." 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div className="h-32 w-full relative overflow-hidden">
               ...
               <div className="absolute top-2 right-2">
                 <span className={clsx(
                   ...
                   {proc.status === 'active' ? 'EN PROCESO' : 'ATENCIÓN'}
                 </span>
               </div>
            </div>
            <CardContent className="p-5">
              ...
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                   <span className="text-gray-500 flex items-center gap-1"><Package className="w-4 h-4" /> Fase Actual</span>
                   <span className="font-medium text-blue-600">{proc.phase}</span>
                </div>
                <div className="flex justify-between text-sm">
                   <span className="text-gray-500 flex items-center gap-1"><Calendar className="w-4 h-4" /> Inicio</span>
        ...
        >
          ...
          <h3 className="font-semibold text-lg">Iniciar Nuevo Proceso</h3>
          <p className="text-sm text-center mt-1 max-w-[200px]">Configure un nuevo lote y asigne una receta de maduración.</p>
        </div>
      </div>
    </div>
  );
      ...
      <Card className="border-gray-200 shadow-lg">
        <CardContent className="p-8">
           <div className="mb-8 border-b border-gray-100 pb-4">
             <h2 className="text-2xl font-bold text-gray-900">Nuevo Proceso de Maduración</h2>
             <p className="text-gray-500 mt-1">Ingrese los datos del lote y configure los parámetros iniciales.</p>
           </div>
           ...
           <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); onSave(); }}>
             ...
             <div className="space-y-4">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 ...
                 <div>
                   <label className="block text-sm font-medium text-gray-700 mb-1">Nombre del Cliente / Empresa</label>
             ...
             <div className="space-y-4">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Dispositivo Control</label>
                    <select className="w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
             ...
             <div className="space-y-4">
               <div className="flex justify-between items-center">
                 ...
                 <Button type="button" variant="outline" size="sm" onClick={() => setStep('custom-recipe')}>
                   <Plus className="w-3 h-3 mr-1" /> Crear/Editar Personalizada
                 </Button>
               </div>
               
               <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                 <label className="block text-sm font-medium text-blue-800 mb-2">Seleccionar Receta de Biblioteca</label>
                 <select 
